...
//            Toast.makeText(LoginActivity.this, "验证码不能为空", Toast.LENGTH_SHORT).show();
        ...
        RequestBody requestBody = new FormBody.Builder()
			.add("__VIEWSTATE", "dDwyODE2NTM0OTg7Oz5i0DGuxjGwiX3e3DXx5iA11dygvw==")
                .add("__VIEWSTATEGENERATOR", "92719903")
			.add("txtUserName", editText_username.getText().toString().trim())
                .add("TextBox2", editText_password.getText().toString().trim())
			.add("txtSecretCode", editText_code.getText().toString().toString())
